...
public class CommandManger extends ListenerAdapter {
	...
	public void onGuildReady(GuildReadyEvent event) 
	{
			...
			// Add command on guild 
				...
				OptionData WishRemoveChar = new OptionData(OptionType.STRING, "character", "character to remove from wishlist" , true, true); 
				...
				commandList.add(Commands.slash("insertsona", "Insert your sona add name, imgur url and games it can be part of!").addOptions(name,url,kdm,smashpass,simps,ships,kins,waifu, fav,guess,collect)); 
				...
				commandList.add(Commands.slash("insertoc", "Insert an original character to current server you can only have 10 ocs per server!").addOptions(name,url,kdm,smashpass,simps,ships,kins,waifu, fav, guess, collect)); 
